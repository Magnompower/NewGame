...
public abstract class Armor {
    ...
    private ArmorCondition armorCondition;
    ...
    @Override
    public String toString() { // TODO ADD PLACEHOLDER CUZ LOGIC CHANGE WITH AGI ADDED TO DEFENCE
        ...
        String armorDetails = String.format("%sArmor:  %s  %s%-20.20s%s:%s%2s%s%s|%s%2s%s%s Reduction%s", //TODO FOrmat
